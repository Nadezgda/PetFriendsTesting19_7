...
def test_add_pets_with_valid_data(name='Нил', animal_type='лебедь', age='4', pet_photo='images/Нил.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Нил', 'лебедь', '4', 'images/Нил.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_photo_at_pet(pet_photo='images/Стронг.jpg'):
...
def test_add_pet_negative_age_number(name='Стронг', animal_type='Тойтерьер', age='-3', pet_photo='images/Стронг.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Стронг', animal_type='тойтерьер', age='1234', pet_photo='images/Стронг.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='лебедь', age='4', pet_photo='images/Нил.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='лебедь', age='4', pet_photo='images/Нил.jpg'):
    ...
    name = 'Роза Быстрый Рыжик Пончик Пушок Мурзик Масяня Мусук Плюшка Моня Кыся'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Нил', age='4', pet_photo='images/Нил.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Нил', animal_type='34562', age='4',
                                                      pet_photo='images/Нил.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Нил', age='4', pet_photo='images/Нил.jpg'):
    ...
    animal_type = 'восточно европейский перелетный нормандский лебедь белый серый черный с черными лапами'
